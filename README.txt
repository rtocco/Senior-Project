...
To Do List:
   ...
   - Extend the subset of SQL currently implemented. Right now, only the simple
      ...
      - Greater than and less than now work in the predicate.
...
IV. Running Client Programs
  ...
  student-course database.  The folder contains a subfolder named
  simpledb.  The subfolder contains programs that
