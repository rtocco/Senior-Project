...
/**
 * The Plan class for the <i>fulljoin</i> operator.
 * @author Edward Sciore
 */
public class FullJoinPlan implements Plan {
   private Plan p1, p2;
   private String fldname1, fldname2;
   private Schema sch = new Schema();

   /**
    * Creates a fulljoin plan for the two specified queries.
    ...
    */
   public FullJoinPlan(Plan p1, Plan p2, String fldname1, String fldname2, Transaction tx) {
   ...
   public Scan open() {
      ...
      return new FullJoinScan(s1, s2, fldname1, fldname2);
   }
