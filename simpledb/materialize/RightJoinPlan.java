...
/**
 * The Plan class for the <i>rightjoin</i> operator.
 * @author Edward Sciore
 */
public class RightJoinPlan implements Plan {
   private Plan p1, p2;
   private String fldname1, fldname2;
   private Schema sch = new Schema();

   /**
    * Creates a rightjoin plan for the two specified queries.
    ...
    */
   public RightJoinPlan(Plan p1, Plan p2, String fldname1, String fldname2, Transaction tx) {
   ...
   /** The method first sorts its two underlying scans
     ...
     */
   public Scan open() {
      SortScan s1 = (SortScan) p1.open();
      Scan s2 = p2.open();
      return new RightJoinScan(s1, s2, fldname1, fldname2);
   }
