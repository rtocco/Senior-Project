...
/**
 * The Plan class for the <i>leftjoin</i> operator.
 * @author Edward Sciore
 */
public class LeftJoinPlan implements Plan {
   private Plan p1, p2;
   private String fldname1, fldname2;
   private Schema sch = new Schema();

   /**
    * Creates a leftjoin plan for the two specified queries.
    ...
    */
   public LeftJoinPlan(Plan p1, Plan p2, String fldname1, String fldname2, Transaction tx) {
   ...
   public Scan open() {
      ...
      return new LeftJoinScan(s1, s2, fldname1, fldname2);
   }
